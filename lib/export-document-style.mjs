export const exportDocumentCss = `
  ...
  * { box-sizing: border-box; }
  ...
  body {
    font-family: "Noto Sans SC Variable", ui-sans-serif, -apple-system, BlinkMacSystemFont, "Segoe UI", "Noto Sans", "Noto Sans CJK SC", "PingFang SC", "Microsoft YaHei", Arial, sans-serif;
  ...
  .conversation-image { margin: 14px 0; break-inside: avoid; }
  .conversation-image img { margin: 0 auto; border-radius: 8px; }
  .conversation-image-unavailable { display: grid; gap: 4px; margin: 14px 0; padding: 12px 14px; border: 1px solid #dddcd7; border-radius: 7px; background: #f7f6f3; color: #66625d; break-inside: avoid; }
  .conversation-image-unavailable strong { color: #34312d; }
  .conversation-image-unavailable span { font-size: 12px; line-height: 1.5; }
  hr { margin: 1.35em 0; border: 0; border-top: 1px solid #e5e5e1; }
  .math-expression { padding: 0; background: transparent; white-space: normal; }
  .math-display { display: block; margin: .9em 0; text-align: center; overflow: visible; break-inside: avoid; }
  .math-inline { display: inline-block; vertical-align: -.12em; }
  .katex-mathml { font-family: "Cambria Math", "STIX Two Math", "Noto Sans Math", serif; }
